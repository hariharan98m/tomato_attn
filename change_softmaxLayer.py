...
#changing layer design for last layer
    ...
    new_model.load_weights('softmaxChangeCheckpoint.hdf5')
    ...
    # checkpoint
    filepath="softmaxChangeCheckpoint2.hdf5"
...
#        print ("Evaluating on fold" + str(index+1) +"/5")
       ...
       # print(model.evaluate_generator(val_seq)
        ...
        # list all data in history
            ...
            plt.show()
            plt.savefig('acc'+str(index+1)+ '.png')
            ...
            plt.legend(['train', 'val'], loc='upper left')
            plt.show()
            plt.savefig('loss'+str(index+1)+ '.png')
        except: 
            #save model
